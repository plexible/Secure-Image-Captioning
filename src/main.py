...
#Image
image_path = "assets/embedding_images/image2.webp"
output_path = "assets/embedded_images/embedded_img.png"

#Key
key = show_n_generate(image_path, greedy = True).encode("utf-8")
...
#Deep Learning Model
key = show_n_generate(output_path, greedy = True).encode("utf-8")    
generated_embedding_key = embedding_key(key)
